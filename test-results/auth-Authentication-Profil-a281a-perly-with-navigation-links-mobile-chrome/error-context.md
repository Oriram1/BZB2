...
- Name: auth.spec.ts >> Authentication & Profile Flows >> Landing page loads properly with navigation links
...
Expected pattern: /Busy Bee/i
Received string:  "התחברות · PrimeOS"
Timeout: 5000ms

Call log:
  - Expect "toHaveTitle" with timeout 5000ms
    11 × locator resolved to <html lang="he" dir="rtl">…</html>
       - unexpected value "התחברות · PrimeOS"
...
- main:
  - img "PrimeOS"
  - heading "כניסה למערכת" [level=1]
  - paragraph: התחברו כדי להמשיך לעבודה במערכת.
  - text: כתובת מייל
  - textbox "כתובת מייל"
  - text: סיסמה
  - link "שכחתי סיסמה":
