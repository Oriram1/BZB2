...
- Name: auth.spec.ts >> Authentication & Profile Flows >> Auth role selection page renders tasker and bee options
...
Locator: locator('text=מציע מטלות')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=מציע מטלות')
