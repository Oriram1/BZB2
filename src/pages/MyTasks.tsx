  ...
  return (
    <div className="min-h-screen bg-muted" dir="rtl">
      ...
      <div className="max-w-3xl mx-auto py-8 px-4">
        <h1 className="text-3xl font-bold text-foreground mb-6">המטלות שלי 📋</h1>
                    ...
                    {task.interested.map((person, idx) => (
                      ...
                      >
                        ...
                        <div className="flex gap-2">
                          <Button
                            size="sm"
                            className="gradient-honey text-primary-foreground rounded-full border-none hover:opacity-90 font-semibold"
                          >
                            קבל ✓
                          </Button>
                          <Button
                            size="sm"
                            variant="outline"
                            className="rounded-full border-border text-muted-foreground hover:text-destructive hover:border-destructive"
                          >
                            דחה ✕
                          </Button>
                        </div>
