...
const mockTasks: Task[] = [
  ...
  { id: 5, name: "עזרה במתמטיקה", shortDesc: "שיעור פרטי מתמטיקה לכיתה י׳", category: "tutoring", categoryLabel: "📚 לימודים", payment: 70, paymentType: "hour", location: "פתח תקווה", date: "2026-02-21", time: "15:00", duration: 1.5, workers: 1, status: "open", lat: 32.09, lng: 34.88, distance: 6.2 },
  { id: 6, name: "הרכבת ארון", shortDesc: "הרכבת ארון איקאה 3 דלתות", category: "handyman", categoryLabel: "🔧 הנדימן", payment: 100, paymentType: "task", location: "ראשון לציון", date: "2026-02-18", time: "12:00", duration: 2, workers: 1, status: "open", lat: 31.96, lng: 34.80, distance: 8.0 },
];
